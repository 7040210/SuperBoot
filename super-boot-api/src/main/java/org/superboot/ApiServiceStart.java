...
import org.superboot.repository.sql.SysApiRepository;
 ...
 * @date 2017/9/5
 * @time 16:25
 * @Path org.superboot.ApiServiceStart
 */
@EnableSwagger2Doc
...
public class ApiServiceStart {
    ...
    public static void main(String[] args) {
        SpringApplication.run(ApiServiceStart.class, args);
    }
    ...
    public void detectHandlerMethods(){
        ...
        for(RequestMappingInfo info : mappings) {
            ...
            //获取API信息
            List<SysApi> list = sysApiRepository.findByUrlAndMethodName(url,methodName);
